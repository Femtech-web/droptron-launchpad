...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return <div className="app-shell">
    ...
    <header className="app-header">
      <div className="app-header__left"><Link className="app-brand" href="/"><Mark /><strong>droptron <span>/ launch desk</span></strong></Link><nav className="app-nav" aria-label="App navigation"><Link href="/app" aria-current={launchesActive ? "page" : undefined}>Launches</Link><Link href="/app/distributions" aria-current={active("/app/distributions") || active("/app/vesting") ? "page" : undefined}>Distributions</Link><Link href="/app/claims" aria-current={active("/app/claims") ? "page" : undefined}>Claims</Link><Link href="/app/wallet" aria-current={active("/app/wallet") ? "page" : undefined}>Wallet</Link></nav></div>
